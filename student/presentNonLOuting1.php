  ...
  <?php
    if (session_status() === PHP_SESSION_NONE) {
     ...
     include '../dbconnect.php';
        ...
        $connect=mysqli_query($conn,"update non_local set InTime=CURRENT_TIMESTAMP,status='1',InDate=CURRENT_TIMESTAMP where Studentid='$regno' and status='0'");
        $query=mysqli_query($conn,"select * from non_local where Studentid='$regno'");
        ...
        <div class="card">
            <div class="content">
                ...
                <div class="contentBx">
                    ...
                    <h5><?php echo "Out Date: ",$rows['InDate']?></h5>
                    <h5><?php echo "Out Time: ",$rows['OutTime']?></h5>
                    <h5><?php echo "In Day: ",$rows['InDate']?></h4>
