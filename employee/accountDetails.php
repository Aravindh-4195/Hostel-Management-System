        ...
        <div class="main-user-info">
          <div class="user-input-box">
            ...
            <input type="text"
                    id="regno"
                    name="regno"
                      value="<?php echo $empid ?>" disabled class="form-control"/>
          </div>
          <div class="user-input-box">
...
if($result){
  ...
  header("Refresh:0.01;url=employeedashboard.php",true,303);
  }
}
}
else{
...
$result=mysqli_query($conn,$query);
if($result){
  echo " <script type='text/javascript'> alert('account details updated succesfully') </script> ";
  header("Refresh:0.01;url=employeedashboard.php",true,303); 
}
}
}
